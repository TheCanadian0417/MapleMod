...
public class ModFluids
{
    ...
    public static final ResourceLocation MAPLE_SYRUP_STILL_RL = new ResourceLocation(MapleMod.MOD_ID,
            "blocks/maple_syrup_still");

    public static final ResourceLocation MAPLE_SYRUP_FLOWING_RL = new ResourceLocation(MapleMod.MOD_ID,
            "blocks/maple_syrup_flowing");

    public static final ResourceLocation MAPLE_SYRUP_OVERLAY_RL = new ResourceLocation(MapleMod.MOD_ID,
            "blocks/maple_syrup_overlay");

    public static final RegistryObject<FlowingFluid> MAPLE_SYRUP
            = Registration.FLUIDS.register("maple_syrup",
            () -> new ForgeFlowingFluid.Source(ModFluids.MAPLE_SYRUP_PROPERTIES));

    public static final RegistryObject<FlowingFluid> MAPLE_SYRUP_FLOWING
            = Registration.FLUIDS.register("maple_syrup_flowing",
            () -> new ForgeFlowingFluid.Flowing(ModFluids.MAPLE_SYRUP_PROPERTIES));

    public static final ForgeFlowingFluid.Properties MAPLE_SYRUP_PROPERTIES = new ForgeFlowingFluid.Properties(
            () -> MAPLE_SYRUP.get(), () -> MAPLE_SYRUP_FLOWING.get(), FluidAttributes.builder(MAPLE_SYRUP_STILL_RL, MAPLE_SYRUP_FLOWING_RL)
            .density(15).viscosity(15).sound(SoundEvents.ITEM_BUCKET_FILL).overlay(MAPLE_SYRUP_OVERLAY_RL)).slopeFindDistance(3).levelDecreasePerBlock(3)
            .block(() -> ModFluids.MAPLE_SYRUP_BLOCK.get()).bucket(() -> ModItems.MAPLE_SYRUP_BUCKET.get());

    public static final RegistryObject<FlowingFluidBlock> MAPLE_SYRUP_BLOCK = Registration.BLOCKS.register("maple_syrup",
            () -> new FlowingFluidBlock(() -> ModFluids.MAPLE_SYRUP.get(), AbstractBlock.Properties.create(Material.WATER)
                    .doesNotBlockMovement().hardnessAndResistance(100f).noDrops()));
