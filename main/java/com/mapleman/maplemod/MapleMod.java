...
import com.mapleman.maplemod.setup.ClientProxy;
import com.mapleman.maplemod.setup.IProxy;
import com.mapleman.maplemod.setup.ServerProxy;
...
public class MapleMod
{
    ...
    public static final ItemGroup MAPLEMOD_TAB = new ItemGroup("maplemodTab") {
        @Override
        public ItemStack createIcon() {
            return new ItemStack(ModItems.MAPLE_LEAF.get());
        }
    };
